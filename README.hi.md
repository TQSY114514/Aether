...
## दो उत्पाद रूप, एक एकीकृत कोर

Aether **डुअल-इंजन आर्किटेक्चर** के साथ आता है, जो पूरी तरह से समान प्रथम श्रेणी के दो इंटरफ़ेस प्रदान करता है और एक ही एजेंट रनटाइम, SQLite मेमोरी और 3-स्तरीय सुरक्षा सैंडबॉक्स साझा करता है:

- 🖥️ **Aether Desktop (GUI)** — रिच टाइपोग्राफी, ड्रैग-एंड-ड्रॉप, विज़ुअल मॉडल एरिना और सहज कॉन्फ़िगरेशन सेंटर के साथ Electron + React ग्राफिकल UI। **अधिकांश दैनिक विकास और नए उपयोगकर्ताओं के लिए अनुशंसित।** ([GitHub Releases](#डाउनलोड-डेस्कटॉप) से डाउनलोड करें, तुरंत तैयार)
- ⌨️ **Aether टर्मिनल (CLI / TUI / SDK)** — तुरंत स्टार्टअप, पूर्ण कीबोर्ड नियंत्रण, लाइन-वार डिफ समीक्षा और SSH व CI/CD ऑटोमेशन के लिए नेटिव समर्थन के साथ Ink v5 टर्मिनल UI। **टर्मिनल-उन्मुख डेवलपर्स और ऑटोमेशन के लिए निर्मित।** (`npm i -g aetherai`, [सेटअप →](#डाउनलोड-cli--tui--sdk))

> 💡 **सहज निरंतरता**: दोनों `agentCore`, 42 टूल, SQLite मेमोरी, मल्टी-मॉडल रूटिंग, MCP सर्वर और एक ही सत्र स्टोर साझा करते हैं। GUI में शुरू की गई चैट को TUI में `aether tui --session <id>` से जारी रखा जा सकता है, और इसका उल्टा भी।

---

**Aether की स्थिति — पूरी ईमानदारी से।** सार्वजनिक जानकारी के आधार पर 20 प्रमुख टर्मिनल, IDE और स्वायत्त एजेंट उपकरणों के विरुद्ध स्व-मूल्यांकन (2026-09 नवीनतम मूल्यांकन; अनुमान, बेंचमार्क नहीं)। हम असममित आकार को बिना किसी बनावट के प्रस्तुत करते हैं: स्थानीय गोपनीयता, 3-स्तरीय सैंडबॉक्स सुरक्षा और मल्टी-मॉडल लचीलेपन में अग्रणी; और Claude Code व Cursor की तुलना में शुद्ध कोडिंग में अंतर को खुले तौर पर स्वीकार करते हैं। विस्तृत तुलना के लिए [docs/competitive-analysis.md](docs/competitive-analysis.md) देखें।

<p align="center"><img src="./assets/agent-radar-2026.hi.svg" width="760" alt="Aether ईमानदार आत्म-मूल्यांकन रडार" /></p>

<sub>चार्ट <a href="./app/scripts/gen-radar.cjs">app/scripts/gen-radar.cjs</a> द्वारा तैयार किया गया — सभी 20 उपकरणों के स्कोर अंतर्निहित हैं; <code>node app/scripts/gen-radar.cjs</code> के साथ पुनः उत्पन्न किया जा सकता है।</sub>
...
`aether` और `aetherai` एक ही पैकेज पर रिज़ॉल्व होते हैं। डेस्कटॉप रिलीज़ से मेल खाने के लिए `npm install -g aetherai@0.9.0` से वर्ज़न पिन करें।
...
**पूर्वापेक्षाएँ:** Node.js 22+, npm 9+
