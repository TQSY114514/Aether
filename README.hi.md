...
**Aether की स्थिति।** सार्वजनिक जानकारी के आधार पर, रिलीज़ किए गए v0.9.0 का 20 प्रमुख टर्मिनल, IDE और प्लेटफ़ॉर्म एजेंट उपकरणों से स्व-मूल्यांकन (2026-09; व्यक्तिपरक अनुमान, बेंचमार्क नहीं)। केवल दो अक्ष श्रेणी में सर्वश्रेष्ठ के बराबर हैं: मल्टी-प्रोवाइडर स्वतंत्रता और स्थानीय गोपनीयता। कोडिंग, इकोसिस्टम, मल्टी-एजेंट ऑर्केस्ट्रेशन, सुरक्षा (केवल ऐप-स्तरीय सैंडबॉक्स, OS-स्तरीय अलगाव नहीं, केवल Windows) और डेस्कटॉप / TUI अनुभव में Aether अभी शीर्ष समूह से पीछे है — और चार्ट यही दिखाता है। प्रति-अक्ष तर्क और 29 उपकरणों का व्यापक सर्वेक्षण [docs/competitive-analysis.md](docs/competitive-analysis.md) में देखें।

<p align="center"><img src="./assets/agent-radar-2026.hi.svg" width="760" alt="Aether आत्म-मूल्यांकन रडार बनाम 20 उपकरण" /></p>
