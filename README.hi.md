...
**Aether की स्थिति — पूरी ईमानदारी से।** सार्वजनिक जानकारी के आधार पर 18 प्रमुख टर्मिनल, IDE और स्वायत्त एजेंट उपकरणों के विरुद्ध स्व-मूल्यांकन (2026-09 नवीनतम मूल्यांकन; अनुमान, बेंचमार्क नहीं)। हम असममित आकार को बिना किसी बनावट के प्रस्तुत करते हैं: स्थानीय गोपनीयता, 3-स्तरीय सैंडबॉक्स सुरक्षा और मल्टी-मॉडल लचीलेपन में अग्रणी; और Claude Code व Cursor की तुलना में शुद्ध कोडिंग में अंतर को खुले तौर पर स्वीकार करते हैं। विस्तृत तुलना के लिए [docs/competitive-analysis.md](docs/competitive-analysis.md) देखें।

<p align="center"><img src="./assets/agent-radar-2026.hi.svg" width="760" alt="Aether ईमानदार आत्म-मूल्यांकन रडार" /></p>

<sub>चार्ट <a href="./app/scripts/gen-radar.cjs">app/scripts/gen-radar.cjs</a> द्वारा तैयार किया गया — सभी 18 उपकरणों के स्कोर अंतर्निहित हैं; <code>node app/scripts/gen-radar.cjs</code> के साथ पुनः उत्पन्न किया जा सकता है।</sub>
