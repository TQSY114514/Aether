...
AetherAI कई LLM प्रदाताओं — OpenAI / Claude / DeepSeek / स्थानीय मॉडल / कोई भी OpenAI-संगत एंडपॉइंट — को एक ही डेस्कटॉप ऐप में एकीकृत करता है। एक एजेंट जो फ़ाइलें पढ़ता/लिखता है और कमांड चलाता है, एक वर्कस्पेस सैंडबॉक्स, ELO मतदान के साथ मल्टी-मॉडल एरिना, skills, और 15 UI भाषाएँ। सब कुछ स्थानीय रूप से संग्रहीत होता है: आपकी API कुंजियाँ और वार्तालाप आपके द्वारा विन्यस्त प्रदाताओं को छोड़कर कहीं और नहीं जाते।
