...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  provider: {
    ...
    testLatency: (id, modelName) => ipcRenderer.invoke('provider:test-latency', id, modelName),
  ...
  git: {
    undo: (opts) => ipcRenderer.invoke('git:undo', opts),
    ...
    craftCommitMessage: (opts) => ipcRenderer.invoke('git:craftCommitMessage', opts),
    commit: (opts) => ipcRenderer.invoke('git:commit', opts),
    getDiffForReview: (opts) => ipcRenderer.invoke('git:getDiffForReview', opts),
  },
  model: {
  ...
  chat: {
    ...
    listPermissionRules: (sessionId) => ipcRenderer.invoke('chat:permissions:list', { sessionId }),
    savePermissionRule: (name, ruleKey, decision) => ipcRenderer.invoke('chat:permissions:save', { name, ruleKey, decision }),
    removePermissionRule: (name, ruleKey) => ipcRenderer.invoke('chat:permissions:remove', { name, ruleKey }),
    applyPermissionPreset: (preset) => ipcRenderer.invoke('chat:permissions:applyPreset', { preset }),
    ...
    onTurnSummary: (cb) => subscribe('chat:turn-summary', cb),
    onMemorySaved: (cb) => subscribe('chat:memory-saved', cb),
    onSkillPatched: (cb) => subscribe('chat:skill-patched', cb),
    compact: (sessionId) => ipcRenderer.invoke('chat:compact', sessionId),
    test: (opts) => ipcRenderer.invoke('chat:test', opts),
    lint: (opts) => ipcRenderer.invoke('chat:lint', opts),
  },
  arena: {
    ...
    objectiveRun: (data) => ipcRenderer.invoke('arena:objective-run', data),
    objectiveStop: (data) => ipcRenderer.invoke('arena:objective-stop', data),
