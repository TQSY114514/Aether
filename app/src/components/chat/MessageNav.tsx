  ...
  return (
    <>
      ...
      >
        ...
        {hoverMsg && (
          <div
            className="absolute z-50 bg-[var(--content-bg)] border border-[var(--border)] rounded-lg shadow-elevated p-2.5 text-xs pointer-events-none transition-opacity duration-100"
            style={{
              top: mouseY,
              left: '100%',
              marginLeft: '8px',
