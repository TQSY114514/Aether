...
[![GitHub downloads](https://img.shields.io/github/downloads/TQSY114514/Aether/total?style=flat-square&label=downloads)](https://github.com/TQSY114514/Aether/releases) [![npm downloads](https://img.shields.io/npm/dm/aetherai?style=flat-square&label=npm%20downloads)](https://www.npmjs.com/package/aetherai) [![clones](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/TQSY114514/Aether/badges/traffic.json&label=clones%20(14d)&cacheSeconds=86400&style=flat-square)](https://github.com/TQSY114514/Aether/blob/badges/traffic.json)
...
**Where Aether stands — honestly.** Self-scored against peer agents from public information (2026-08; estimates, not benchmarks). We publish the asymmetric shape as-is: strongest where local-first matters — multi-provider, privacy, safety, desktop UX — and not yet top-of-class at raw coding. That is the trade-off you are buying into.

<p align="center"><img src="./assets/agent-radar-2026.svg" width="700" alt="Aether honest self-assessment radar vs Claude Code, Codex, OpenCode, Cursor, Cline, OpenClaw, Gemini CLI, OpenHands" /></p>

<sub>Chart generated by <a href="./app/scripts/gen-radar.cjs">app/scripts/gen-radar.cjs</a> — scores embedded there verbatim; regenerate with <code>node app/scripts/gen-radar.cjs</code>.</sub>
