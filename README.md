...
**Where Aether stands — honestly.** Self-scored against 18 leading terminal, IDE, and platform agent tools from public information (2026-09 latest assessment; estimates, not benchmarks). We publish the asymmetric shape as-is: strongest where local-first matters — multi-provider, privacy, 3-tier safety, and dual-mode UX — and not yet top-of-class at raw coding. That is the trade-off you are buying into. See [docs/competitive-analysis.md](docs/competitive-analysis.md) for the in-depth comparative review.

<p align="center"><img src="./assets/agent-radar-2026.en.svg" width="760" alt="Aether honest self-assessment radar vs 18 peer agents (Claude Code, Codex, Cursor, Windsurf, Trae, Devin, OpenHands, DSH, Amp, Gemini Code Assist, etc.)" /></p>

<sub>Chart generated by <a href="./app/scripts/gen-radar.cjs">app/scripts/gen-radar.cjs</a> — scores for all 18 tools embedded verbatim; regenerate with <code>node app/scripts/gen-radar.cjs</code>.</sub>
