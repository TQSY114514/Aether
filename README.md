...
**Where Aether stands — honestly.** Self-scored against 29 leading terminal, IDE, and platform agent tools from public information (2026-09 latest assessment; estimates, not benchmarks). We publish the asymmetric shape as-is: strongest where local-first matters — multi-provider, privacy, 3-tier safety, and dual-mode UX — and not yet top-of-class at raw coding. That is the trade-off you are buying into. See [docs/competitive-analysis.md](docs/competitive-analysis.md) for the in-depth comparative review.

<p align="center"><img src="./assets/agent-radar-2026.en.svg" width="760" alt="Aether honest self-assessment radar vs 29 peer agents (Claude Code, Codex, Cursor, Devin Desktop, Trae, Devin, OpenHands, DSH, Amp, Gemini Code Assist, etc.) — subset chart" /></p>

<sub>Radar subset chart generated by <a href="./app/scripts/gen-radar.cjs">app/scripts/gen-radar.cjs</a> — shows an 18-peer subset on the radar axes; the full 29-tool comparison lives in <a href="./docs/competitive-analysis.md">docs/competitive-analysis.md</a>. Regenerate with <code>node app/scripts/gen-radar.cjs</code>.</sub>
