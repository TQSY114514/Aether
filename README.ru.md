...
**Где находится Aether — честная оценка.** Самооценка в сравнении с 18 ведущими терминальными, IDE и автономными агентами на основе открытых данных (актуальность: 2026-09; оценки, не бенчмарки). Мы открыто показываем асимметричную форму: лидируем в локальной приватности, 3-уровневой песочнице и мультипровайдерах; откровенно признаем объективное отставание в чистом кодинге от Claude Code и Cursor. Подробный сравнительный анализ см. в [docs/competitive-analysis.md](docs/competitive-analysis.md).

<p align="center"><img src="./assets/agent-radar-2026.ru.svg" width="760" alt="Честный радар самооценки Aether vs 18 систем" /></p>

<sub>Диаграмма сгенерирована через <a href="./app/scripts/gen-radar.cjs">app/scripts/gen-radar.cjs</a> — баллы 18 инструментов встроены дословно; воспроизводится с помощью <code>node app/scripts/gen-radar.cjs</code>.</sub>
