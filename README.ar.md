...
`aether` و `aetherai` يحلّان إلى نفس الحزمة. ثبّت إصدارًا محدّدًا بـ `npm install -g aetherai@0.9.0` لمطابقة إصدار سطح المكتب.
