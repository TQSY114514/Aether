...
**موقع Aether.** تقييم ذاتي للإصدار المنشور v0.9.0 مقارنةً بـ 20 أداة رائدة عبر سطر الأوامر وبيئات التطوير والمنصات بناءً على بيانات عامة (2026-09؛ تقديرات ذاتية وليست اختبارات معيارية). محوران فقط يوازيان الأفضل في الفئة: حرية تعدد المزوّدين والخصوصية المحلية. أما في البرمجة والمنظومة وتنسيق الوكلاء المتعددين والأمان (صندوق حماية على مستوى التطبيق فقط، بلا عزل على مستوى نظام التشغيل، Windows فقط) وتجربة سطح المكتب / الطرفية، فلا يزال Aether خلف المجموعة الأولى، والرسم يوضح ذلك. المسوّغات لكل محور والمسح الأوسع لـ 29 أداة في [docs/competitive-analysis.md](docs/competitive-analysis.md).
