...
### محطة عمل ذكاء اصطناعي لسطح المكتب، متعدّدة النماذج، محلّية أولاً
...
يوحّد AetherAI عدّة مزوّدات LLM — OpenAI / Claude / DeepSeek / نماذج محلّية / أي نقطة نهاية متوافقة مع OpenAI — في تطبيق واحد لسطح المكتب. وكيل يقرأ ويكتب الملفات ويشغّل الأوامر، وصندوق رمل لمساحة العمل، وساحة متعدّدة النماذج مع تصويت ELO، ومهارات، و15 لغة واجهة. كل شيء مخزّن محلّياً: مفاتيح API ومحادثاتك لا تغادر جهازك إلّا إلى المزوّدين الذين تُهيّئهم.
...
حمّل أحدث [إصدار](https://github.com/TQSY114514/AetherAI/releases):
