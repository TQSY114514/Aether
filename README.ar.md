...
**موقع Aether.** تقييم ذاتي للإصدار المنشور v0.8.2 مقارنةً بـ 20 أداة رائدة عبر سطر الأوامر وبيئات التطوير والمنصات بناءً على بيانات عامة (2026-09؛ تقديرات ذاتية وليست اختبارات معيارية). محوران فقط يوازيان الأفضل في الفئة: حرية تعدد المزوّدين والخصوصية المحلية. أما في البرمجة والمنظومة وتنسيق الوكلاء المتعددين والأمان (صندوق حماية على مستوى التطبيق فقط، بلا عزل على مستوى نظام التشغيل، Windows فقط) وتجربة سطح المكتب / الطرفية، فلا يزال Aether خلف المجموعة الأولى، والرسم يوضح ذلك. المسوّغات لكل محور والمسح الأوسع لـ 29 أداة في [docs/competitive-analysis.md](docs/competitive-analysis.md).

<p align="center"><img src="./assets/agent-radar-2026.ar.svg" width="760" alt="رادار التقييم الذاتي لـ Aether مقابل 20 أداة" /></p>

<sub>تم إنشاء الرسم البياني بواسطة <a href="./app/scripts/gen-radar.cjs">app/scripts/gen-radar.cjs</a> — درجات الأدوات الـ 20 مضمنة حرفياً؛ يمكن إعادة إنتاجه عبر <code>node app/scripts/gen-radar.cjs</code>.</sub>
