...
> **بدأ Aether كتطبيق سطح مكتب.** تمت إضافة CLI و TUI لاحقًا ولا تزال قيد التحسين. إذا كنت تريد فقط بيئة عمل ذكاء اصطناعي عاملة، ابدأ بـ **Aether Desktop**. طبقة CLI/TUI/SDK تجريبية: قد تتغير الواجهات والسلوك، وقد تكون بعض الميزات غير مكتملة أو غير موثوقة.
