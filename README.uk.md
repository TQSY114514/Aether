...
**Де знаходиться Aether — чесна оцінка.** Самооцінка в порівнянні з 18 провідними термінальними, IDE та автономними агентами на основі відкритих даних (актуальність: 2026-09; оцінки, не бенчмарки). Ми відкрито демонструємо асиметричну форму: ведемо в локальній приватності, 3-рівневій пісочниці та мультипровайдерах; відверто визнаємо відставання в чистому коді від Claude Code і Cursor. Докладний порівняльний аналіз див. у [docs/competitive-analysis.md](docs/competitive-analysis.md).

<p align="center"><img src="./assets/agent-radar-2026.uk.svg" width="760" alt="Чесний радар самооцінки Aether vs 18 систем" /></p>

<sub>Діаграма згенерована через <a href="./app/scripts/gen-radar.cjs">app/scripts/gen-radar.cjs</a> — бали 18 інструментів вбудовані дослівно; відтворюється за допомогою <code>node app/scripts/gen-radar.cjs</code>.</sub>
