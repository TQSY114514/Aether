...
**Де знаходиться Aether.** Самооцінка випущеної v0.8.2 у порівнянні з 20 провідними термінальними, IDE та платформними агентами на основі відкритих даних (2026-09; суб’єктивні оцінки, не бенчмарки). Лише дві осі на рівні найкращих у класі: свобода вибору провайдера та локальна приватність. У кодингу, екосистемі, оркестрації агентів, безпеці (пісочниця на рівні застосунку, без ізоляції ОС, лише Windows) та зрілості desktop / TUI Aether поки відстає від першої групи — і діаграма це показує. Обґрунтування по осях і розширений огляд 29 інструментів: [docs/competitive-analysis.md](docs/competitive-analysis.md).

<p align="center"><img src="./assets/agent-radar-2026.uk.svg" width="760" alt="Радар самооцінки Aether vs 20 систем" /></p>
